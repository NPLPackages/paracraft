...
local function _isMatch(blockIndex,blockX, blockY, blockZ)
  ...
  if block_pos_x and block_pos_x.modelName == "slope" then
    block_index_pos_x=BlockEngine:GetBlockData(blockX+1, blockY, blockZ);
  end
  if block_neg_x and block_neg_x.modelName == "slope" then
    block_index_neg_x=BlockEngine:GetBlockData(blockX-1, blockY, blockZ);
  end
  if block_pos_y and block_pos_y.modelName == "slope" then
    block_index_pos_y=BlockEngine:GetBlockData(blockX, blockY+1, blockZ);
  end
  if block_neg_y and block_neg_y.modelName == "slope" then
    block_index_neg_y=BlockEngine:GetBlockData(blockX, blockY-1, blockZ);
  end
  if block_pos_z and block_pos_z.modelName == "slope" then
    block_index_pos_z=BlockEngine:GetBlockData(blockX, blockY, blockZ+1);
  end
  if block_neg_z and block_neg_z.modelName == "slope" then
    block_index_neg_z=BlockEngine:GetBlockData(blockX, blockY, blockZ-1);
  end
