...
function ItemTimeSeriesCommands:CreateActorFromItemStack(itemStack, movieclipEntity, isReuseActor, name, movieclip)
	local actor = ActorCommands:new():Init(itemStack, movieclipEntity, isReuseActor, name, movieclip);
	return actor;
end
