--[[
Title: EntityBlockEditor
Author(s): leio
Date: 2020/12/8
Desc: 
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aries/Creator/Game/Entity/EntityBlockEditor.lua");
local EntityBlockEditor = commonlib.gettable("MyCompany.Aries.Game.EntityManager.EntityBlockEditor")
-------------------------------------------------------
]]
...
local Entity = commonlib.inherit(commonlib.gettable("MyCompany.Aries.Game.EntityManager.EntityBlockBase"), commonlib.gettable("MyCompany.Aries.Game.EntityManager.EntityBlockEditor"));

Entity:Property({"EditorType", "", "GetEditorType", "SetEditorType"})

-- class name
Entity.class_name = "EntityBlockEditor";
...
function Entity:OpenEditor()
    ...
    local url = string.format("%snpl_block_editor/blockcad?blockpos=%s",site_url,blockpos);
