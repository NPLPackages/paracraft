--[[
Title: CommonDef_Math
Author(s): leio
Date: 2020/12/14
Desc: 
use the lib:
-------------------------------------------------------
local CommonDef_Math = NPL.load("(gl)script/apps/Aries/Creator/Game/Code/CommonDefs/CommonDef_Math.lua");
-------------------------------------------------------
]]
NPL.export({
...

{
	...
	helpUrl = "", 
	canRun = false,
	func_description = 'math.%s(%s,%s)',
	func_description_js = 'Math.%s(%s,%s)',
	func_description_py = '%s(%s,%s)',
	ToNPL = function(self)
		return ""
	end,
	examples = {{desc = "", canRun = true, code = [[
